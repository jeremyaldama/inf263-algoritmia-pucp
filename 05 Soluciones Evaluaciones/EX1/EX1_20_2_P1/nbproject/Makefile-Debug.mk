...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ex1_20_2_p1.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ex1_20_2_p1.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ex1_20_2_p1 ${OBJECTFILES} ${LDLIBSOPTIONS}
